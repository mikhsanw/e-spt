...
<div class="row">
    <div class="col-md-12">
        ...
        <p>
            ...
            {!! Form::select('tingkat', config('master.tingkat_jabatan'), null, array('id' => 'tingkat', 'class' => 'form-control tingkat', 'placeholder'=>'Pilih','style' => 'width:100%')) !!}
        </p>
        <p>
            {!! Form::label('penandatangan', 'Pilih Penandatangan', array('class' => 'control-label')) !!}
            {!! Form::select('penandatangan', config('master.penandatangan'), null, array('id' => 'penandatangan', 'class' => 'form-control tingkat','style' => 'width:100%')) !!}
        </p>
    </div>
