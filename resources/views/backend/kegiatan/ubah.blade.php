...
<div class="row">
    <div class="col-md-12">
        ...
        <p>
            {!! Form::label('kode_rekening', 'Masukkan Kode Rekening', array('class' => 'control-label')) !!}
            {!! Form::text('kode_rekening', $data->kode_rekening, array('id' => 'kode_rekening', 'class' => 'form-control', 'autocomplete' => 'off')) !!}
        </p>
        <p>
